...
<script>
import { reqPwdLogin, reqSendCode, reqSmsLogin } from '../../../../code/gshop-client_final/src/api';
import AlertTip from '../../components/AlertTip/AlertTip.vue'
export default {
  // 初始化
  data () {
    return {
      loginWay: true, // true代表短信登陆，false密码登录
      phone: '', // 手机号
      code: '', // 短信验证码
      computeTime: 0, // 计时时间
