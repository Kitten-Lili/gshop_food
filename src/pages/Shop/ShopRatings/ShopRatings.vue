  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="rating-wrapper">
        <ul>
          <li class="rating-item" v-for="(rating, index) in fileerRatings" :key="index">
            <div class="avatar">
...
import BScroll from 'better-scroll'
  ...
  export default {
    data(){
      return {
        onlyShowText: false, // 是否只显示有文本的内容
    ...
    computed:{
      ...
      fileerRatings(){
        ...
        return ratings.filter(rating=>{
          ...
          /**
           * 条件1: 
           *  selectType: 0,1,2   选择评价类型
           *  rateType: 0/1       评论里面定义的类型
           *  selectType === 2 || selectType === rateType
           * 条件2:
           *  onlyShowText: true/false  是否只显示有评论内容的
           *  text: 有值/没值
